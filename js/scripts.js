document.addEventListener("DOMContentLoaded", function() {
	...
	popupElements.forEach(element => {
		if (element.classList.contains('js-popup-select')) {
			let popupElementSelectItem = element.querySelectorAll('.js-popup-block li .button-select')
			if (element.querySelector('.js-popup-block .button-select.active')) {
				element.classList.add('select-active')
				let popupElementActive = element.querySelector('.js-popup-block .button-select.active').innerHTML
			...
			for (i = 0; i < popupElementSelectItem.length; i++) {
				popupElementSelectItem[i].addEventListener('click', function (e) {
					...
					if (this.closest('.js-popup-wrap').querySelector('.js-popup-block .button-select.active')) {
						this.closest('.js-popup-wrap').querySelector('.js-popup-block .button-select.active').classList.remove('active')
					}
					this.classList.add('active')
					let popupElementActive = element.querySelector('.js-popup-block .button-select.active').innerHTML
					let popupElementButton = element.querySelector('.js-btn-popup-toggle')
